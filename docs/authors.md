...
Source:
[`inst/CITATION`](https://github.com/BlasBenito/spatialRF/blob/HEAD/inst/CITATION)
...
Blas M. Benito (2025). R package spatialRF: Easy Spatial Regression with
Random Forest. doi: 10.5281/zenodo.4745208. url:
