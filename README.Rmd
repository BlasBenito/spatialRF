...
<!-- README.md is generated from README.Rmd. Please edit that file -->
  ...
  <!-- badges: start -->
  [![R build status](https://github.com/BlasBenito/spatialRF/workflows/R-CMD-check/badge.svg)](https://github.com/BlasBenito/spatialRF/actions)
...
Models fitted with `rf()` and other `rf_X()` functions within the pacakge can be predicted onto new data just as it is done with `ranger()` models:
