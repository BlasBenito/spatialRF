...
The function adds a new slot to the model named `importance.cv`. It contains the spatial folds used in the spatial cross-validation, the names of the predictors with a positive effect (using only these predictors in a new model improves model transferability!), dataframes with the raw and aggregated results of the spatial cross-validation, and the plot shown above.
