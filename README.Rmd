...
spatialRF::plot_training_df_moran(
  ...
  distance.thresholds = distance.thresholds = c(0, 1500, 3000),
...
plant_richness_df[, "climate_bio1_average_X_bias_area_km2"] <- interactions$df[, "climate_bio1_average_X_bias_area_km2"]
