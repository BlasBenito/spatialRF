...
The package is designed to minimize the amount of code required to fit a spatial model from a dataset and a distance matrix. The code below shows all that is needed to fit a spatial model:
