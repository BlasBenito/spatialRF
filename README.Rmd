...
If we join the case coordinates with the local importance scores, we can get an idea on how variable importance changes over space.
...
```
This can be done as well with the `pdp` package.
...
The function `rf_spatial()` adds the slot **spatial**. Keep going to better understand what can be found in this slot before taking a look at it!
