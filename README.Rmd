...
The package is not yet in the CRAN repositories, so at the moment it must be installed from GitHub as follows. Notice that there are two branches in the GitHub repository, "main" and "development". If you install it from "development", things will likely go wrong! Please, install it from "main" even if the code chunk below says otherwise!
