...
The function [`rf_interactions()`](https://blasbenito.github.io/spatialRF/reference/rf_interactions.html) tests all possible interactions of both types among the most important predictors, and suggesting the ones not correlated among themselves and with the other predictors that have an importance above the median, and a positive increase in the model's R squared (as computed on the out-of-bag data).
