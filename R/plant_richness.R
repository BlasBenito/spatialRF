#' Vascular plant richness of the World's Ecoregions.
#'
#' Richness of vascular plants of most of the worlds ecoregions defined in [Ecoregions 2017](https://ecoregions2017.appspot.com/).
#' plant_richness
#'
#' @format A data frame and sf file with 662 rows and 27 columns:
#' \describe{
...
#'   \item{fragmentation_core_mn}{another fragmentation index.}
#'   \item{fragmentation_dcore_mn}{another fragmentation index.}
#'   \item{fragmentation_ed}{another fragmentation index.}
#'   \item{fragmentation_para_mn}{another fragmentation index.}
#'   \item{fragmentation_shape_mn}{another fragmentation index.}
