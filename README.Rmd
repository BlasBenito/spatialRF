...
As an example, I will choose `climate_bio1_average_X_bias_area_km2` hypothesizing that ecoregions with higher area (bias_area_km2) and energy (represented by the annual temperature, climate_bio1_average) will have more species of vascular plants. The data required to add it ot the dataset is inside the output of `rf_interactions()`. A similar rationale (more energy + more neighbors = more species)
 could have been followed to select `climate_bio1_average_X_neighbors_count` as well.
