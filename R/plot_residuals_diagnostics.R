...
#' @param fill.color Character string, fill color of the bars produced by `ggplot2::geom_histogram()`. Default: `grDevices::hcl.colors(4, palette = "Zissou 1", alpha = 0.95 )[2]`
