...
The package follows a convention throughout functions:
  ...
  + The argument `dependent.variable.name` is the column name of the response variable. We will use the character string `ecoregions_continuous_response`.
  + The argument `predictor.variable.names` contains the column names of the predictors. We will use the character vector `ecoregions_numeric_predictors`.
