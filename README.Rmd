...
Notice that here I plug the object `variable.selection`, output of `auto_cor()` and `auto_vif()`, directly into the `predictor.variable.names` argument.
...
The spatial autocorrelation of the residuals of `model.non.spatial.tuned`  can be plotted with `plot_moran()`
